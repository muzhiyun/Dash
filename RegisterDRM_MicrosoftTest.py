...
def main():
	...
	obj["Test1234"]=register(DRM_TYPE.TEST, options.authtest, "0x00000000000000000000000000000001", "0x00000000000000000000000000000001")
	obj["Test1235"]=register(DRM_TYPE.TEST, options.authtest, "0x00000000000000000000000000000002", "0x00000000000000000000000000000002")
	
	obj["Test1236"]=register(DRM_TYPE.TEST, options.authtest, "0xc14f0709f2b94427916b61b52586506a", base64.b64decode("7fsXeXJHs8enQ0SEfkhTBQ==").hex())
	obj["Test1237"]=register(DRM_TYPE.TEST, options.authtest, "0x914e69f40ab345349e9f9853615e26f6", base64.b64decode("0DBllUYESc5WdSJMebqlBA==").hex())
	obj["Test12341235"]=registerMultiKey(DRM_TYPE.TEST, options.authtest, 
		[
			[ obj["Test1235"]["kid.0"], obj["Test1235"]["key.0"], "2000" ],
			[ obj["Test1234"]["kid.0"], obj["Test1234"]["key.0"], "2000" ]
		],
		"CENC"
	)
